		...
		return function () {
			setSelectedTags((selectedTags) => {
				if (selectedTags.includes(id))
					return selectedTags.filter((originId) => originId !== id);
		...
		<div>
			...
			<div className="flex items-center h-[--editor-title-height] ">
				...
				<div className="relative flex items-center">
					<button
						onClick={publish}
						className=" bg-juejin-brand-1-normal text-juejin-gray-0 px-8 mr-4 p-3 rounded-full  hover:bg-juejin-brand-2-hover"
					>
						发布
					</button>
					<div
			...
			<footer className="fixed h-[--editor-footer-height] leading-[--editor-footer-height] bottom-0 left-0 right-0 border-t border-t-juejin-editor-border z-50 bg-juejin-bg text-sm">
				...
				<span className="float-right mr-2 cursor-pointer btn-text">
					回到顶部
				</span>
			</footer>
		</div>
