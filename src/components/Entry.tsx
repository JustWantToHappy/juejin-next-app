...
const Entry: React.FC<EntryType> = ({ id, title, content, readCount, author, image, likes, tags }) => {
  ...
  return (
    <li className='h-[100px] break-words text-left px-[--home-recommend-padding-x] pt-4 list-none duration-300 transition-all ease-in border-b-juejin-gray-1-1 border-b flex gap-x-4 cursor-pointer hover:bg-juejin-gray-3 leading-7 text-sm text-juejin-font-3 overflow-hidden items-center'>
      <div className='flex-1'>
        <div>
          <Link href='/' title={title} className=' text-lg font-extrabold text-juejin-font-1'>
