...
export const VirtualList = React.forwardRef<HTMLDivElement, Props>(
	(props, ref) => {
		const {
			preHeight = 50,
			extraRenderCount = 4,
		...
		const getVirtualItemHeight = React.useCallback(
			(index: number) => {
		...
		const setVirtualItemHeight = React.useCallback(
